    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card card-custom" style="background-color:#1f2937; color:#e5e7eb; min-height:220px;">
                        ...
                        <div class="info-row">
                            <span>Tanggal</span>
                            <strong>{{ $tanggalMulai->format('d M Y') }} - {{ $tanggalSelesai->format('d M Y') }}</strong>
                        </div>
                        <div class="info-row">
                            <span>Durasi</span>
                        ...
                        <div class="info-row">
                            <span>Jam</span>
                            <strong>{{ $reservasi->jadwal->jam_mulai ?? '-' }} - {{ $reservasi->jadwal->jam_selesai ?? '-' }}</strong>
                        </div>
                        @endif
                        <div class="info-row">
            ...
            <div class="mt-4 d-flex justify-content-end gap-2">
                ...
                <a href="{{ route('user.reservasi.struk', $reservasi->id) }}" target="_blank" class="btn btn-success">Cetak Struk</a>
                @elseif(in_array(optional($p)->status, ['expired', null]))
                <a href="{{ route('user.pembayaran.create', $reservasi->id) }}" class="btn btn-warning">Bayar Ulang</a>
                @endif
            </div>
